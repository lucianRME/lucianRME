...
SynapseWorks is where I build and publish focused software across Chrome, Android, and enterprise workflows.
...
- [RME PDF Scanner on GitHub](https://github.com/lucianRME/rme-pdf-scanner)
